...
body {
	background-image: url("http://bgfons.com/upload/ornaments_texture1127.jpg");
...
<body>
	...
	<header>
		<center>
		<h1 style="font-family:monotype corsiva;"><img src="https://www.colourbox.com/preview/13237051-online-shopping.jpg	" height="77" width="77" style="font-family: monotype corsiva;" /><b>Mobilecart</b></h1>
	</center>
...
<div  ng-app="addToCartApp"  ng-controller = "addToCartCtrl"  ng-init="retrieveCart('${cartId}')">
	 ...
	 <div >
        <table class="table table-bordered" style="font-family:initial;color:white;font-size: 1em;" >
		  <thead>
			  <tr>
			  <th>Product</th>
				<th >Unit Price</th>
 ...
 cartApp.controller("addToCartCtrl", function ($scope, $http){
      ...
      */
      $scope.removeItemFromCart = function (id) {
         $http['delete']('http://localhost:8080/mobilecart/categoryDropdown/productDisplay/usercart/cart/removeItem/'+id).success(function (data) {
     ...
     $scope.addItemToCart = function (id) {
         $http.put('http://localhost:8080/mobilecart/usercart/cart/addItem/'+id).success(function (data) {
     ...
     $scope.refreshCartItems = function () {
         $http.get('http://localhost:8080/mobilecart/categoryDropdown/productDisplay/usercart/cart/refreshCart/'+$scope.cartId).success(function (data) {
            $scope.cart=data;
         });
     };
     ...
     $scope.clearCartItems = function () {
     	$http['delete']('http://localhost:8080/mobilecart/categoryDropdown/productDisplay/usercart/cart/clearCartItems/'+$scope.cartId).success(function (data)
     			{$scope.refreshCartItems()
     		});
     };
 });
